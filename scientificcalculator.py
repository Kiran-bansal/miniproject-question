...
class Calculator:
    def __init__(self, master):
        ...
        top_frame = tk.Frame(
            master, width=650, height=10, bd=10, relief="flat", bg="gray"
        )
        ...
        self.btn_MR = tk.Button(
            bottom_frame, **btn_params, text="MR", command=self.memory_recall
        )
        ...
        self.btn_M_plus = tk.Button(
            bottom_frame, **btn_params, text="M+", command=self.memory_add
        )
        ...
        self.btn_ans = tk.Button(
            bottom_frame, **btn_params, text="ans", command=self.answer
        )
        self.btn_ans.grid(row=4, column=3)
        # comma to allow for more than one parameter!
        self.btn_comma = tk.Button(
            bottom_frame, **btn_params, text=",", command=lambda: self.btn_click(",")
        )
